...
public class ProductResource {
    ...
    public ResponseEntity<List<ProductDTO>> getAllProducts(
        ...
        Page<ProductDTO> page = productQueryService.findByCriteria(criteria, filter, pageable);
    ...
    public ResponseEntity<Long> countProducts(ProductCriteria criteria, @RequestParam(required = false) String filter) {
        log.debug("REST request to count Products by criteria: {}", criteria);
        return ResponseEntity.ok().body(productQueryService.countByCriteria(criteria, filter));
    }
